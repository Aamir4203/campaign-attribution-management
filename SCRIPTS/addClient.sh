...
then
        ...
        echo -e " Hi Team, \n\n ERROR: Client Name is missing as an Argument. \n\n Thanks,\n DataAttribution" | mail -r "$ALERT_SENDER" -s "New Client Additon :: APT TOOL" $ALERT_TO
